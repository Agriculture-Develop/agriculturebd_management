      ...
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="data-card" shadow="hover">
          ...
          <div class="data-card-footer">
            ...
            <el-button link type="primary" @click="$router.push('/super-admin/user')"
              >管理</el-button
            >
          </div>
        </el-card>
      ...
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="data-card" shadow="hover">
          ...
          <div class="data-card-footer">
            ...
            <el-button link type="primary" @click="$router.push('/super-admin/news/list')"
              >查看</el-button
            >
          </div>
        </el-card>
      ...
      <el-col :xs="24" :sm="12" :md="6">
        <el-card class="data-card" shadow="hover">
          ...
          <div class="data-card-footer">
            ...
            <el-button link type="primary" @click="$router.push('/super-admin/news/drafts')"
              >查看</el-button
            >
          </div>
        </el-card>
            ...
            <el-table :data="pendingTasks" style="width: 100%" :show-header="false" size="large">
              <el-table-column width="50">
                <template #default="scope">
                  <el-avatar
                    :size="32"
                    :style="{ backgroundColor: getStatusColor(scope.row.type) }"
                  >
          ...
          <div class="quick-actions">
            <div class="quick-action-row">
              <el-button
                ...
                @click="$router.push('/super-admin/user')"
              >
                <el-icon>
                  <Plus />
                </el-icon>
              ...
              <el-button
                ...
                class="quick-action-btn"
                @click="$router.push('/super-admin/news/write')"
              >
                <el-icon>
                  <Edit />
                </el-icon>
              ...
              <el-button
                type="info"
                class="quick-action-btn"
                @click="$router.push('/super-admin/publish/unpublished')"
              >
                <el-icon>
                  <DataAnalysis />
                </el-icon>
