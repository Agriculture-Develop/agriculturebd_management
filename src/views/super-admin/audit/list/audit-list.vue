  ...
  <div class="audit-list-container">
    ...
    <el-card class="table-card">
      <div class="table-header">
        ...
        <el-button type="success" :style="{ backgroundColor: secondaryColor }" @click="batchApprove">批量通过</el-button>
      </div>

      <el-table :data="auditList" style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column label="操作" width="220">
          <template #default="scope">
            ...
            <el-button size="small" type="success" :style="{ backgroundColor: secondaryColor }"
              @click="approveNews(scope.row)" :disabled="scope.row.status === '已通过'">
              通过
            </el-button>
            <el-button size="small" type="danger" @click="rejectNews(scope.row)" :disabled="scope.row.status === '已拒绝'">
              驳回
            </el-button>
          </template>
        </el-table-column>
    ...
    <el-dialog v-model="rejectDialogVisible" title="驳回原因" width="500px">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" :style="{ backgroundColor: primaryColor }" @click="confirmReject">确定</el-button>
        </span>
      </template>
    </el-dialog>
  </div>
